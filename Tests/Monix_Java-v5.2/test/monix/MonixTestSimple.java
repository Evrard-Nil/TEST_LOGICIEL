...
public class MonixTestSimple
{
	...
	private void recuperationVueCaisse()
	{
		...
		this.fenetreCaisse = new JFrameOperator(new NameComponentChooser(Monix.IHM.getString("CAISSE_NOM_FENETRE")));
	...
	private void recuperationVueClient()
	{
		...
		this.fenetreClient = new JFrameOperator(new NameComponentChooser(Monix.IHM.getString("CLIENT_NOM_FENETRE")));
		...
		Assert.assertNotNull("Le champ d'information du prix total de la vente n'est pas accessible.", this.texteTotalClient);
