...
public class VueClientTest
{
	 ...
	 * 
	 * <p>Cette méthode s'appuie sur les index des widget pour les récupérer.</p>
	 * 
	 * <p>Cette méthode concerne la récupération de la fenêtre, avec titre adéquat, 
	 * et des widgets attendus pour cette vue.</p>
	 */
	@SuppressWarnings("unused")
	private void recuperationVueparIndex()
	{
		// Récupération de la fenêtre de la vue client (par son titre).
	 ...
	 * 
	 * <p>
	 * Cette méthode s'appuie sur les noms des widget pour les récupérer.
	 * Cette approche nécessite que des noms soient associés aux widgets.
	 * Une bonne pratique veut que ces noms soient issus des spécifications de l'IHM.
	 * </p>
	 * 
	 * <p>Cette méthode concerne la récupération de la fenêtre, avec titre adéquat, 
	 * et des widgets attendus pour cette vue.</p>
	...
	private void recuperationVue()
	{
		...
		this.fenetre = new JFrameOperator(new NameComponentChooser(Monix.IHM.getString("CLIENT_NOM_FENETRE")));
		Assert.assertNotNull("La fenêtre de la vue client n'est pas accessible.", this.fenetre);
