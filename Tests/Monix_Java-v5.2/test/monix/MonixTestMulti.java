...
public class MonixTestMulti
{
	...
	private static void recuperationVueCaisse(int index)
	{
		...
		fenetreCaisse[index] = new JFrameOperator(new NameComponentChooser(Monix.IHM.getString("CAISSE_NOM_FENETRE")), index);
		...
		Assert.assertNotNull("Le champ de saisie de la quantité de produits n'est pas accessible.",	texteQuantite[index]);
		
		// Récupération du champ de libellé d'un produit (par son nom).
		...
		// Récupération du champ de prix d'un produit (par son nom).
		...
		// Récupération du champ d'information d'un achat (par son nom).
		...
		// Récupération du bouton d'annulation d'un produit à la vente (par son nom).
		...
		Assert.assertNotNull("Le bouton d'annulation d'un produit de la vente n'est pas accessible.", boutonAnnuler[index]);
		
		// Récupération du bouton de clôture de la vente (par son nom).
	...
	{
		// Récupération de la fenêtre de la vue client (par son nom).
		fenetreClient[index] = new JFrameOperator(new NameComponentChooser(Monix.IHM.getString("CLIENT_NOM_FENETRE")), index);
		Assert.assertNotNull("La fenêtre de la vue client n'est pas accessible.", fenetreClient[index]);
		
		// Récupération du champ d'information du prix total de la vente (par son nom).
		...
		Assert.assertNotNull("Le champ d'information du prix total client n'est pas accessible.", texteTotalClient[index]);

		// Récupération du panneau texte de la vue (ticket) (par son nom).
