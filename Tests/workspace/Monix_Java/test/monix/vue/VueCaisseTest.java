...
public class VueCaisseTest
{
	 ...
	 * Récupération de la vue caisse.
	 * 
	 * <p>Cette méthode s'appuie sur les valeurs des widget pour les récupérer.</p>
	 * 
	 * <p>Cette méthode concerne la récupération de la fenêtre, avec titre adéquat, 
	 * et des widgets attendus pour cette vue.</p>
	 */
	@SuppressWarnings("unused")
	private void recuperationVueParValeur()
	{
		// Récupération de la fenêtre de la vue de la caisse (par son titre).
		this.fenetre = new JFrameOperator(Monix.MESSAGES.getString("CAISSE_TITRE_FENETRE"));
		Assert.assertNotNull("La fenêtre de la vue caisse n'est pas accessible.", this.fenetre);
	 ...
	 */
	@SuppressWarnings("unused")
	private void recuperationVueParNom()
	{
		// Récupération de la fenêtre de la vue de la caisse (par son nom).
		this.fenetre = new JFrameOperator(new NameComponentChooser(Monix.IHM.getString("CAISSE_NOM_FENETRE")));
		Assert.assertNotNull("La fenêtre de la vue caisse n'est pas accessible.", this.fenetre);
