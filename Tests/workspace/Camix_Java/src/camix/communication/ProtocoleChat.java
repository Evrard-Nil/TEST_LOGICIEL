...
public final class ProtocoleChat
{
	...
	/**
	 * Commande de fermeture du client
	 */
	public static final char COMMANDE_FERMETURE_CLIENT = 'q';
	 ...
	 * </ul></p>
	 */
	public static final String MESSAGE_ARRIVEE_CHAT = "* Un nouvel utilisateur est dans le chat (%s).%n";
	 ...
	 * par le caractère COMMANDE_CARACTERE et en le suffixant par un espace.</p>
	 *
	...
	{
		return Character.toString(ProtocoleChat.COMMANDE_CARACTERE) + commande + " "; 
	}
